...
$this->Input("char_port[]",'3306',"&nbsp;&nbsp;&nbsp;<strong>".$installer_lang['Port']."</strong>: ",' ('.$installer_lang['required'].')','char_port'.$i);
