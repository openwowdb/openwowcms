...
$username = preg_replace( "/[^0-9]/", "", $username );//this is GUI
...
*
function confirmUserPass($username, $password){//TOD
global $db
...
return $db->query($q) or die($q.'<br>'.mysql_error())
...
//echo $query_string
$sendmail=false
$db2->query($query_string) or ($sendmail=mysql_error())
if($sendmail==false
