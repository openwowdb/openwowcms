...
if($user->logged_in){
   ...
   echo "<p><b>$user->username</b> ".$lang['you\'ve already registered'].". "
       ."</p>";
	  return;
}
 ...
 */
   ...
   if($_SESSION['regsuccess']){
      ...
      echo "<p>".$lang['Thank you']." <b>".$_SESSION['reguname']."</b>, ".$lang['your information has been added'].". "
          ."</p>";
   }
   /* Registration failed */
   else{
      echo "<h1>".$lang['Fail']."</h1>";
      echo "<p>".$lang['Error has occurred and your registration for the']." ".strtolower($lang['Username'])." <b>".$_SESSION['reguname']."</b>."
          ."</p>";
   }
