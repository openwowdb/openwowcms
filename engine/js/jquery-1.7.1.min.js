...
function ajax_loadContent(divid,filename,temptext)
{
	if (temptext!='false')
	{
		$('#'+divid).fadeOut("fast");
		if (temptext)
		{
			document.getElementById(divid).innerHTML=temptext;
		}
		else
		{
	...
	$().ajaxStop(function(r,s) { $('#'+divid).fadeIn("fast"); });
}

$(document).ready( function() {
	if ($.browser.webkit) {
		$('select').css({ "background-image": "none", "background-color": "#333", "border-radius": "4px", "border": "1px solid #888"});
	}
});
