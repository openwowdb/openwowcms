...
<title><?php echo $config['title']; ?> - Terms Of Use</title>
...
body {
	...
	background-image:url(engine/tos/bg.jpg);
...
<textarea rows="20" style="width:96%; color:#ffac04; border: 1px #777777 solid;" readonly="readonly">
TERMS OF SERVICE:
*****************
